...
import fm.a2d.sf.service.RadioService;
  ...
  public com_api (Context context) {                                    // Context constructor
    ...
    Presets = new PresetsManager(m_context);
  }
...
///*
  public void key_set (String key, String val, String key2, String val2) {  // Presets currently require simultaneous preset frequency and name
    ...
    //  return;
    //}
    intent.setClass (m_context, RadioService.class);
    intent.putExtra (key, val);
...
//*/
  public void key_set (String key, String val) {
    ...
    try {
      ...
      //intent.setClass (m_context, RadioService.class);
      intent.setComponent (new android.content.ComponentName ("fm.a2d.sf", "fm.a2d.sf.service.RadioService"));
      intent.putExtra (key, val);
      if (m_context != null)
        m_context.startService (intent);
      else
  ...
  public Intent service_update_send (Intent intent, String phase, String cdown) {
    if (intent == null)                                                 // If for RadioService and not for phase/cdown/count
